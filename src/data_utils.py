...
### FARE AMOUNT
    ...
    #app_train.loc[app_train["airport_fee"].isin([0, 1.25]), "RatecodeID"] = np.nan
    #app_test.loc[app_test["airport_fee"].isin([0, 1.25]), "RatecodeID"] = np.nan
    ...
    #app_test.drop("total_amount", inplace=True, axis=1)
    #app_train.drop("total_amount", inplace=True, axis=1)

    #app_test.drop("congestion_surcharge", inplace=True, axis=1)
    #app_train.drop("congestion_surcharge", inplace=True, axis=1)

    #app_test.drop("airport_fee", inplace=True, axis=1)
    #app_train.drop("airport_fee", inplace=True, axis=1)

    #app_test.drop("pickup_year", inplace=True, axis=1)
    #app_train.drop("pickup_year", inplace=True, axis=1)

    #app_test.drop("pickup_minute", inplace=True, axis=1)
    #app_train.drop("pickup_minute", inplace=True, axis=1)

    #app_test.drop("trips_per_hour", inplace=True, axis=1)
    #app_train.drop("trips_per_hour", inplace=True, axis=1)
    ...
    #columns_to_drop = ['fare_amount', 'tolls_amount','airport_fee','tip_amount']
